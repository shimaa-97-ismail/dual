...
// export function DisplayWeeklyAbsenr({students,attendance_summary}) {
//     console.log(students,attendance_summary);
...
//             <TableHead className="w-[100px] text-center"> الاسم</TableHead>
//             <TableHead className="text-center">السبت </TableHead>
//             <TableHead className="text-center"> الاحد</TableHead>
//             <TableHead className="text-center">الاتنين</TableHead>
//             <TableHead className="text-center"> الثلاثاء</TableHead>
//             <TableHead className="text-center">الاربعاء</TableHead>
//             <TableHead className="text-center">الخميس </TableHead>
//             <TableHead className="text-center">الجمعة</TableHead>
//             <TableHead className="text-center"> ح</TableHead>
//             <TableHead className="text-center">غ</TableHead>
//             <TableHead className="text-center"> م</TableHead>
//              <TableHead className="text-center">اج</TableHead>
//               <TableHead className="text-center">اجمالى ايام الاسبوع</TableHead>
//           </TableRow>
//         </TableHeader>
//         <TableBody>
