    ...
    <>
      <div className="px-6">
        <div className="grid ">
          <div className="grid grid-cols-2 items-center mb-3">
            ...
            <select
              ...
              onChange={(e) =>
                onChange("academicyearForPayment", e.target.value)
              }
              required
              className="border p-2 rounded col-span-1 w-53"
            >
        ...
        <div className="grid ">
          ...
          {errors.amountDueReceipt1 && (
            <p className="text-sm text-red-600">{errors.amountDueReceipt1}</p>
          )}
        </div>
        <div className="grid ">
          <div className="grid grid-cols-2 items-center mb-3">
          ...
          {errors.receipt1 && (
            <p className="text-sm text-red-600">{errors.receipt1}</p>
          )}
        </div>
        ...
        <div className="grid ">
          <div className="grid grid-cols-2 items-center  mb-3">
            <LabelForm
              ...
              className="text-right"
              title={"قيمه ايصال المركز الوطنى"}
              required={true}
            />
            <Input
          ...
          {errors.amountDueReceipt2 && (
            <p className="text-sm text-red-600">{errors.amountDueReceipt2}</p>
          )}
        </div>
        <div className="grid ">
          ...
          {errors.receipt2 && (
            <p className="text-sm text-red-600">{errors.receipt2}</p>
          )}
        </div>
